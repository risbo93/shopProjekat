 ...
 */
@WebFilter(filterName="/SuperAdminFilter",urlPatterns = {"/SuperAdminServlet/*","/RegistrujKompanijuServlet/*","/PregledKupovinaServlet/*"})
public class SuperAdminFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
		...
		if(o!=null && o.getUloga().equalsIgnoreCase("SUPERADMIN")){
