...
<title>Registracija Kompanije</title>
...
<body>
	...
	<!-- /.container-fluid --> </nav>
	<form action="/ShopWEB/SuperAdminServlet" method="get">
		<button class="dugme" style="margin-left: 65%; margin-bottom: 2%; display:inline-block;">Nazad</button>
	</form>
	
	<c:choose>
    <c:when test="${poruka4=='trebaPopuniti'}">
<div class="container">
	<div class="row">
		<div class="alert-group">
            <div class="alert alert-warning alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                <strong>Upozorenje!</strong>       Morate popuniti sve podatke!
            </div>
        </div>
	</div>
</div>
        ...
        <c:when test="${poruka4=='nepodudaranje'}">
<div class="container">
	<div class="row">
		<div class="alert-group">
            <div class="alert alert-warning alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                <strong>Upozorenje!</strong>       Passwordi se ne podudaraju!
            </div>
        </div>
	</div>
</div>
    ...
    <c:when test="${poruka4=='uspesno'}">
<div class="container">
	<div class="row">
		<div class="alert-group">
            <div class="alert alert-success alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                <strong>Dodato!</strong> Upesno dodata kompanija.
            </div>
        </div>
	</div>
</div>
...
<div class="row">
		<div class="well">
				...
				<h3>Registruj kompaniju:</h3>
				<form action="/ShopWEB/RegistrujKompanijuServlet" method="post">
					<hr class="colorgraph">
					
					<div class="form-group">
						<input type="text" name="nazivKompanije" id="nazivKompanije"
							class="form-control input-lg" placeholder="Naziv Kompanije" tabindex="6">
					</div>
					<div class="form-group">
						<input type="text" name="adresa" id="adresa"
							class="form-control input-lg" placeholder="Adresa" tabindex="3">
					</div>
					<div class="form-group">
						<input type="text" name="link" id="link"
							class="form-control input-lg" placeholder="Link do slike" tabindex="4">
					</div>
					
					<div class="row">
						<div class="col-xs-12 col-sm-6 col-md-6">
							<div class="form-group">
								<input type="text" name="procenat" id="procenat"
									class="form-control input-lg" placeholder="Procenat Zarade"
									tabindex="8">
							</div>
						</div>
					</div>
					...
					<hr class="colorgraph">
									...
									<h3>Unesite podatke Company Admina:</h3>
					<hr class="colorgraph">
					<div class="row">
						<div class="col-xs-12 col-sm-6 col-md-6">
							...
							<div class="form-group">
								<input type="text" name="ime" id="ime"
									class="form-control input-lg" placeholder="Ime" tabindex="1">
							</div>
						</div>
						<div class="col-xs-12 col-sm-6 col-md-6">
							<div class="form-group">
								<input type="text" name="prezime" id="prezime"
									class="form-control input-lg" placeholder="Prezime"
									tabindex="2">
							</div>
						</div>
					</div>
					<div class="form-group">
						<input type="text" name="username" id="username"
							class="form-control input-lg" placeholder="Username" tabindex="6">
					</div>
					<div class="form-group">
						<input type="text" name="drzava" id="drzava"
							class="form-control input-lg" placeholder="Drzava" tabindex="3">
					</div>
					<div class="form-group">
						<input type="text" name="grad" id="grad"
							class="form-control input-lg" placeholder="Grad" tabindex="4">
					</div>
					<div class="form-group">
						<input type="text" name="ulica" id="ulica"
							class="form-control input-lg" placeholder="Ulica" tabindex="5">
					</div>
					<div class="form-group">
						<input type="text" name="godine" id="godine"
							class="form-control input-lg" placeholder="Godine" tabindex="7">
					</div>
					<div class="row">
						<div class="col-xs-12 col-sm-6 col-md-6">
							<div class="form-group">
						...
						<div class="col-xs-12 col-sm-6 col-md-6">
							<div class="form-group">
								<input type="password" name="passwordConfirm"
									...
									placeholder="Potvrdi Password" tabindex="6">
							</div>
						</div>
					</div>
					<div class="row">
