...
<div class="row">
    ...
    <div class="container">
       <div class="row text-center">
            ...
            <div class="btn-heading">
                 <h1>CompanyAdmin Administracija</h1>
            </div>
            <div style="height:10%;width:50%;margin:auto;">
            <p style="text-align: center"><img src="${linkSlike }" alt="Logo"></p>
            </div>
           <div style="margin-top: 6%">
           <form accept-charset="UTF-8" action="/ShopWEB/PregledKupovinaKompanijeServlet" method="get">
            <button class="btn1" type="sumbit">Pregled narudzbina</button>
            </form>
           </div>
    ...
    <div class="container">
       <div class="row text-center">
           ...
           <div style="margin-top: 6%">
           <form accept-charset="UTF-8" action="/ShopWEB/DodajProizvodServlet" method="get">
            <button class="btn1" type="sumbit">Dodaj proizvod</button>
            </form>
           </div>
...
<section class="effect-btn">
    <div class="container">
       <div class="row text-center">
           ...
           <div style="margin-top: 6%;" >
           <form accept-charset="UTF-8" action="/ShopWEB/UkloniProizvodServlet" method="get">
            <button class="btn1" type="sumbit">Ukloni proizvod</button>
            </form>
           </div>
