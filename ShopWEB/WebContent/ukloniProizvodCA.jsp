...
<form action="/ShopWEB/CompanyAdminServlet" method="get">
	...
	<c:choose>
    <c:when test="${poruka5=='uspesnoUklanjanje'}">
<div class="container">
	<div class="row">
		<div class="alert-group">
            <div class="alert alert-success alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                <strong>Uklonjeno!</strong> Upesno uklonjen proizvod.
            </div>
        </div>
	</div>
</div>
     ...
     <c:when test="${poruka5=='neuspesnoUklanjanje'}">
<div class="container">
	<div class="row">
		<div class="alert-group">
            <div class="alert alert-danger alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
                <strong>Neuspesno!</strong> Proizvod nije uklonjen!
            </div>
        </div>
	</div>
</div>
    ...
    <thead>
        <tr>
            ...
            <th class="text-center">Action</th>
    		 ...
    		 <c:forEach var="stvar" items="${stvari }">
            <tr>
                <td>${stvar.idStvari }</td>
                <td><div style="overflow: auto;width: 160px;">${stvar.naziv }</div></td>
                <td>${stvar.kategorija }</td>
                <td>${stvar.cena }</td>
                <td class="text-center">
                <form  action="/ShopWEB/UkloniProizvodServlet" method="post">
                <input name="odabranaStvar" type="hidden" value="${stvar.idStvari }"> 
